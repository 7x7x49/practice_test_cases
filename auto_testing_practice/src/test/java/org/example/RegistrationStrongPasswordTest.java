...
public class RegistrationStrongPasswordTest extends BeginningClass {
    ...
    @Test
    public void shouldRegisterWithStrongPassword() {
        scroll(driver.findElement(CONTINUE_BTN));
        type(FIRST_NAME, "Татьяна");
        type(LAST_NAME,  "Миндалева");
        type(EMAIL, "miinndall231@mail.ru");
        type(PASSWORD, "sP5@rT&9kL#m2$fJ0");
